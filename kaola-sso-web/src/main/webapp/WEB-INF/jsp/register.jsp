    ...
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post"  >
			...
			<span  class="regM" style="margin-left:29px">
				...
				<a href="https://passport.e3mall.cn/xy.html" target="_blank"  class="checkTitle">我已阅读并同意<font style="font-size:12px;">《考拉商城用户注册协议》</font></a>
			</span>
...
<!--mainOver-->
		...
		<div class="footer">
			...
			<p> 
				北京宜立方电子商务有限公司<br />
				|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">京ICP备12011349号</a>|<a href="http://www.e3mall.cn/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br />
				Copyright© 考拉商城 e3mall.cn 版权所有<br />
			</p>
		</div>
		<!-- /footer -->
